              ...
              <div className="row">
                ...
                <div className="col-lg-12 col-xl-12 text-center mt-3">
                  <div className="style2 mb30-991">
                    <h3 className="heading-forms">Manage Appraisers</h3>
                  </div>
                </div>
                {/* End .col */}
                {/*<div className="row">
                                ...
                                >
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      >
                                        {brokerInfoSelected.commissionRate}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td
                                      ...
                                      >
                                        {brokerInfoSelected.maxNumberOfAssignedOrders}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td
                                      ...
                                      >
                                        {brokerInfoSelected.designation}
                                      </td>
                                    </tr>
                                    <tr>
                                      <td
